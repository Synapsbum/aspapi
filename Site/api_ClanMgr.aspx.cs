...
public partial class api_ClanMgr : WOApiWebPage
{
    void SetClanPoints()
    {
        ...
        sqcmd.CommandText = "WZ_ClanSetPoints";
        sqcmd.Parameters.AddWithValue("@in_ClanID", web.Param("ClanID"));
        sqcmd.Parameters.AddWithValue("@in_Points", web.Param("points"));
	...
	void SetFriendlyFire()
    {
        SqlCommand sqcmd = new SqlCommand();
        sqcmd.CommandType = CommandType.StoredProcedure;
        sqcmd.CommandText = "WZ_SetFriendlyFire";
        sqcmd.Parameters.AddWithValue("@in_ClanID", web.Param("ClanID"));
        sqcmd.Parameters.AddWithValue("@in_SetFriendlyFire", web.Param("friendfire"));
    ...
    protected override void Execute()
    {
        ...
        if (func == "leave")
            ...
            ClanBuySlots();
		else if (func == "friendlyfire")
            SetFriendlyFire();
        else if (func == "setpoints")
            SetClanPoints();
        else
