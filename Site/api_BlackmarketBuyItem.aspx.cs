...
public partial class api_BlackmarketBuyItem : WOApiWebPage
{
    protected override void Execute()
    {
        ...
        sqcmd.CommandText = "WZ_BlackmarketBuyItem";
        ...
        int OutCurrency = getInt("OutCurrency");

        Response.Write("WO_0");
        Response.Write(string.Format("{0} {1} {2} {3} {4} {5} {6} {7}", InventoryID, ItemID, OutQuantity, Var1, Var2, Var3, CurrencyType, OutCurrency));
    }
}
