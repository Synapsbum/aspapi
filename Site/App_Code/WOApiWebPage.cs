...
public abstract class WOApiWebPage : System.Web.UI.Page
{
    ...
    protected string SERVER_API_KEY = "KfZnUUwZFJqrPJ1b4DaNZ3CkGnvz6MzPYAvP86wg";//Fg5jaBgj3uy3ja -> old is AC44RMyzowO7ADHgQA7SKSy8I
    ...
    public WOApiWebPage()
    { // aLca :: on issues check -> https://www.cloudflare.com/ips-v4 this bastards change it all the time!
        CloudFlareIPRanges.Add(new IPSubnet("173.245.48.0/20"));
        CloudFlareIPRanges.Add(new IPSubnet("103.21.244.0/22"));
        CloudFlareIPRanges.Add(new IPSubnet("103.22.200.0/22"));
        CloudFlareIPRanges.Add(new IPSubnet("103.31.4.0/22"));
        ...
        CloudFlareIPRanges.Add(new IPSubnet("197.234.240.0/22"));
        CloudFlareIPRanges.Add(new IPSubnet("198.41.128.0/17"));
        CloudFlareIPRanges.Add(new IPSubnet("162.158.0.0/15"));
        CloudFlareIPRanges.Add(new IPSubnet("104.16.0.0/12"));
        CloudFlareIPRanges.Add(new IPSubnet("172.64.0.0/13"));
        CloudFlareIPRanges.Add(new IPSubnet("131.0.72.0/22"));
        
        // CloudFlareIPRanges.Add(new IPSubnet(""));
    }
